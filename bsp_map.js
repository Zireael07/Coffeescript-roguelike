...
var build_capsule, build_pub, building_factory, building_tag, call_building_fun, create_doors, find_rooms, make_hovel, map_create, paint, paint_leaf, room_doors, room_func, sort_buildings, sort_fun,
...
call_building_fun = function(i, sized, level) {
  ...
  if (sized[i][2] === 3) {
    return build_capsule(sized[i][3], level);
  }
};
