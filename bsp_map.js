...
var create_doors, find_rooms, map_create, paint, paint_leaf, room_doors, room_func;
...
paint_leaf = function(leaf, tree, mapa) {
  if ((leaf.lchild !== void 0) || (leaf.rchild !== void 0)) {
    ...
    if (leaf.rchild) {
      return paint_leaf(leaf.rchild, tree, mapa);
    }
  } else {
    // Create rooms in the end branches of the bsp tree
    return room_func(leaf.leaf, mapa);
  }
};

paint = function(tree, mapa) {
  //for l in tree.leafs
  paint_leaf(tree.rootLeaf, tree, mapa); // throttle default ret
};
...
map_create = function(level = null, max_x = 20, max_y = 20) {
  var bsp_tree, end_x, end_y, i, j, k, l, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, start_x, start_y, x, y;
