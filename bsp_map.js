...
var building_tag, create_doors, find_rooms, make_hovel, map_create, paint, paint_leaf, room_doors, room_func, sort_buildings, sort_fun;
...
sort_buildings = function(rooms) {
  ...
  for (i = j = 0, len = rooms.length; j < len; i = ++j) {
    ...
    building_size.push([i, r.w * r.h, 3]);
  }
